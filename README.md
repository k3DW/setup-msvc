...
* `vs-version` is a required input, denoting the specific version of Visual Studio to install. The patch version can be omitted, which will install the most recent patch in the minor release series. For example specifying `17.13` will install `17.13.7`.
